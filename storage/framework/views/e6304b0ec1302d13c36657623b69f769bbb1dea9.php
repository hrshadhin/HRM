                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <?php echo Form::select('ptype', ['All' => 'All', 'Commerical' => 'Commerical','Residential' =>'Residential', 'Residential & Commerical' => 'Residential & Commerical'], $projectType, ['id' => 'projectType' ,'class' => 'form-control select2-list', 'required' => 'required']); ?>
                ...
                <div class="card-body style-default-bright top-zero">
                  <div class="row">
                    ...
                    <div class="col-xs-5 text-left">
                      <h3 class="text-light text-default-light"><strong>Projects <?php if($projectType !="All"): ?> [<?php echo e($projectType); ?>] <?php endif; ?></strong></h3>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <table class="table table-striped">
                        ...
                        <tfoot>
                        <tr>
                          <td colspan=" <?php if($projectType !="All"): ?> 9 <?php else: ?> 10 <?php endif; ?>" class="text-right"><strong class="text-lg text-default-dark">Total</strong></td>
