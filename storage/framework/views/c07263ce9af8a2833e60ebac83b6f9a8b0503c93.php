                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form class="form form-validate floating-label"
                                  ...
                                  action="<?php echo e(URL::route('user.update',$user->id)); ?>"
                                  method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <?php echo Form::select('role', $roles, $userRole, ['id' => 'projectType' ,'class' => 'form-control select2-list', 'required' => 'required']); ?>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <input type="text"  class="form-control" value="<?php echo e($user->name); ?>" name="name" maxlength="255" required>
                                                    <label for="name">Full name</label>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <input type="email" class="form-control" value="<?php echo e($user->email); ?>" name="email" required>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <input type="password" class="form-control" value="" name="password" placeholder="leave blank if not want to update password">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group">
                                                        <?php $__currentLoopData = $permission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                           ...
                                                           <?php echo e(Form::checkbox('permission[]', $value->id, hasUserPermission($user->id,$value->id), array('class' => 'name'))); ?>
