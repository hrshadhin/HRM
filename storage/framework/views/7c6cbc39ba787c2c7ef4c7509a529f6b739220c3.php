                  ...
                  <div class="card-body tab-content">
                    <div class="tab-pane active" id="first2">
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group">
                            <input type="text" id="nidNo" class="form-control" value="<?php echo e(old('nidNo')); ?>"  name="nidNo" maxlength="50" required>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="form-group">
                            <textarea class="form-control"  name="mailingAddress" maxlength="500" required><?php echo e(old('mailingAddress')); ?></textarea>
