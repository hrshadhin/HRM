                  ...
                  <div class="card-body tab-content">
                    <div class="tab-pane active" id="first2">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            <div class="input-group date">
                              <div class="input-group-content">
                                <input type="text" readonly value="{{$customer->entryDate->format('d/m/Y')}}" class="form-control  pick-date" required>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{$customer->spouseName}}" name="spouseName" maxlength="100">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            <input type="text" class="form-control" value="{{$customer->passportNo}}" name="passportNo" maxlength="50">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            <textarea class="form-control"  name="permanentAddress"  maxlength="500" required>{{$customer->permanentAddress}}</textarea>
