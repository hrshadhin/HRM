                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    {!! Form::select('role', $roles, $userRole, ['id' => 'projectType' ,'class' => 'form-control select2-list', 'required' => 'required']) !!}
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <input type="text"  class="form-control" value="{{$user->name}}" name="name" maxlength="255" required>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group">
                                                        @foreach($permission as $value)
                                                           ...
                                                           {{ Form::checkbox('permission[]', $value->id, hasUserPermission($user->id,$value->id), array('class' => 'name')) }}
